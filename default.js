			...
			function cardBin(event){
				...
				if(textLength >= 6){
					...
					window.Mercadopago.getInstallments({
						bin,
						"amount": parseFloat(document.getElementById('installments').value)
					},getInstallments);
				}
			}
