...
if(Object.getOwnPropertyNames(JSON.parse(localStorage.BOOKmark)).includes(new URL(window.location.href).searchParams.get('id'))){
	...
	if(window.location.href.indexOf('/p/checkout.html') != -1){	
		...
		if(CHECKout){
		var CONTROLLpay = '<div class="FORMdiv"><div class="CONTROLLpayment"><div class="STEPbox"><ul class="steps"> <i class="CROSSstep"></i><li class="step-item"><a id="stepPersonalData" title="Dados pessoais" class="step-item-link tab-personal-data active"><span class="rounded step-number">1</span><span class="step-text">Dados pessoais</span></a></li><li class="step-item"><a id="stepPayment" title="Pagamento" class="step-item-link tab-payment"><span class="rounded step-number">2</span><span class="step-text">Pagamento</span></a></li><li class="step-item"><a id="stepThanks" title="Obrigado!" class="step-item-link"><span class="rounded step-number">3</span><span class="step-text">Obrigado!</span></a></li></ul></div><div class="PAYMENTmethod"><div class="CREDITcardPayment"><div class="SPOTinst"><p><input type="text" id="inputCardName" class="INPUTclass"></input><span for="inputCardName">Nome e sobrenome</span></p><p><input type="email" id="email" class="INPUTclass" name="email"></input><span for="email">Digite seu E-mail</span></p><p><input type="email" class="INPUTclass" id="confirmEmail"></input><span>Confirmação de E-mail</span></p><div class="NEXTstep"><button class="BTTNstep BTNtype" type="button">Próximo passo</button></div></div><div class="SPOTinst DISPLAYnone"><form id="pay" name="pay"><p hidden=""><input type="hidden" id="cardholderName" class="INPUTclass" data-checkout="cardholderName"></input><span for="cardholderName">Nome e sobrenome</span></p><p hidden=""><input type="hidden" name="description" id="description" value="Ítem selecionado" disabled="disabled"></input><span for="description" hidden="">Descrição</span></p><p hidden=""><input name="transaction_amount" id="transaction_amount" value="' +VALUEpay+ '" disabled="disabled" type="hidden"></input><span for="transaction_amount" hidden="">Valor a pagar</span></p><p><input type="tel" id="cardNumber" class="INPUTclass" data-checkout="cardNumber" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" maxlength="19" autocomplete="off"></input><span for="cardNumber">Número do cartão</span></p><div class="DISPLAYflex CARDcol1"><p><input type="tel" id="cardExpirationMonth" class="INPUTclass" data-checkout="cardExpirationMonth" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" maxlength="2" autocomplete="off"></input><span for="cardExpirationMonth">MM</span></p><p><input type="tel" id="cardExpirationYear" class="INPUTclass" data-checkout="cardExpirationYear" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" maxlength="2" autocomplete="off"></input><span for="cardExpirationYear">AA</span></p><p><input type="tel" id="securityCode" class="INPUTclass" data-checkout="securityCode" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" maxlength="4" autocomplete="off"></input><span for="securityCode">CVC/CVV</span></p></div><div class="DISPLAYflex CARDcol2"><p> <select id="installments" class="form-control" name="installments"><option value="Parcelas">Parcelas</option> </select> <span for="installments" hidden>Parcelas</span></p><p hidden=""><input type="text" disabled="disabled" name="payment_method_id" id="payment_method_id" hidden=""></input></p></div><div class="DISPLAYflex CARDcol3"><p><select id="docType" data-checkout="docType"></select><span for="docType" hidden>Tipo de documento</span></p><p><input type="tel" id="docNumber" class="INPUTclass" data-checkout="docNumber"></input><span for="docNumber">Número do documento</span></p></div><div class="SUBMITpayment"><button type="submit" id="payment">Finalizar o pagamento</button></div></form></div></div><div class="CARDwrapper"><div class="CARDwrapperInset"><div class="PAYMENDcard"><div class="CARDcol1"><div class="CARDchip"><div class="CARDshiny"></div><div class="CARDbrand"></div></div></div><div class="CARDcol2"><div class="CARDNumber"></div></div><div class="CARDcol3"><div class="CARDname"></div><div class="CARDexpiration"><span class="MMcard"></span><span class="BARtag"></span><span class="AAcard"></span></div></div></div><div class="PAYMENDcard"><div class="CARDcol4"><div class="BLACKtarget"></div></div><div class="CARDcol5"><div class="CARDlines"></div><div class="CARDcode"><span class="CARDcodeNumber"></span></div></div></div></div></div></div></div><div class="PAYMENTbox"><div class="PAYMENTTinst"><div class="PAYMENTtitle"><span class="LICENSEtxt">Premium</span><a target="_blank" href="#"><i class="CIRCLEhelp"></i></a></div><div class="PAYMENTval"><span class="PREMIUMval">' +PRICEpost+ '</span><span class="COINhere">BRL</span></div><div class="PAYMENTTinfo"><h4>' +JSONit.entry.title.$t+ '</h4><p>' +DOCit.body.querySelector('pre').innerText+ '</p><div class="SAFEpost"><i class="CROSSicon DEFENSEit"></i>Compra 100% Segura</div></div></div></div></div>';
	...
	document.getElementById('cardholderName').setAttribute('value', this.value);
	...
	document.getElementById('docNumber').addEventListener('input', function(){
		...
		function formSubmit(TOKENmp, DATEmp, NUMBmp){
			...
			var SUCESSpage = '<div class="SUCESSinst"><div class="SUCESShead"><i class="CROSSicon SUCCESicon"></i></div><p class="SUCESSh1">Perfeito!</p><p class="SUCESStext">Sua compra foi realizada com sucesso e em poucos segundos chegará um e-mail no na sua conta para realizar o login no site e fazer download do seu produto. Agradecemos por preferir Bracael. O código abaixo é a sua chave de segurança em caso de não receber o produto.</p><span class="SECRETkey">'+TOKENmp+'</span><p class="SUCESSbttm">Em caso de não receber o e-mail, entre em contato conosco via WhatsApp e informe o código acima.</p></div>';
