...
if(pLOCAL.split(' ').includes('free') && img.length>=1 && BOLLdmo && BOLLpre && BOLLbxa && BOLLupt && BOLLlyt && pLOCAL.split(' ').length === 1){
	...
	var GETupt = DOCit.body.querySelector('.zip').getAttribute('update').replace(/(-)/gi,'/');
	var GETlyt = DOCit.body.querySelector('.zip').getAttribute('layout')[0].toUpperCase() +	DOCit.body.querySelector('.zip').getAttribute('layout').slice(1);
	summary = '<div class="POSTcontent"><div class="POSTleft"><div class="LEFTinst"><div class="POSTdoor"><img src="'+img[0].src+'"></div><div class="TOOLSpost"><div class="ACTIONpost">' +SHAREpage+ '<div class="LIVEspot"><a class="btn LIVEtemplate" href="/p/demo.html?id=' +pID+ '" target="_blank"><div><i class="SEEit"></i><span>Visualizar tema</span></div></a></div></div></div><div class="DESCpost"><h3>' +pTITLE+ '<i class="CROSSicon" feedback=""></i></h3><div class="TYPEfile"><li>Tipo de arquivo<span>ZIP</span></li><li>Layout<span>' +GETlyt+ '</span></li><li>Última atualização<span>' +GETupt+ '</span></li></div><p>' +GETpre+ '</p><div class="FREEdownload"><li><a class="BTNdownload" href="' +GETbxa+ '"><div class="BTNdownloadLeft"></div><div class="BTNdownloadRight"><span class="MAINtxt">Baixar Grátis</span><span class="SECONtxt">versão de avaliação</span></div></a></li><li class="SECURITYitem">Verificado com <b>Antivírus</b></li></div></div><div class="INFORMATIONpage">' +FEATURESthis+CHANGElog+ '</div></div></div><div class="POSTright"><div class="PURCHASEbox"><div class="PURCHASEinst"><h4><span class="LICENSEtxt">Premium</span><a target="_blank" href="#"><i class="CIRCLEhelp"></i></a></h4><div class="PRICEbar"><span class="PREMIUMval">' +PRICEpost+ '</span><span class="COINhere">BRL</span></div><div class="CHECKOUTwrap"><li>Atualização do template</li><li>Nenhum script criptografado</li><li>3 Meses de suporte</li><li>Para domínios ilimitados</li><li>Remover créditos</li><span class="BUTTONpost"><a href="/p/checkout.html?id=' +pID+ '" rel="nofollow" target="_blank" class="BTNit CHECKout"><i class="CARTit"></i><span>Comprar</span></a></span></div></div></div><div class="STATICbox FACEsec"><div class="fb-page" data-href="https://www.facebook.com/bracaelcom" data-tabs="" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/bracaelcom" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/bracaelcom">Bracael</a></blockquote></div></div></div></div>'; }
else{
